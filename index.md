...
carousels:
  - images: 
    - image: images/Pioneer_deployment_4_16x9.webp
      caption: "Sandia engineers ready Pioneer WEC v1 prototype for testing on NLR's Large Amplitude Motion Platform (LAMP) (credit: Taylor Mankle and Josh Baurer, NLR)"
...
This dashboard shows data from the Pioneer wave energy converter (WEC) v1 prototype's deployment, which provides power to a mooring within the [Coastal Pioneer Array](https://oceanobservatories.org/pioneer-array-relocation/).
...
The Pioneer WEC v1 prototype was deployed on November 2nd, 2025 and recovered on May 1st, 2026 {% cite Coe:2026aa %} -- data from the deployment is available on [MHK-DR](https://mhkdr.openei.org/submissions/714).
A Pioneer WEC v2 prototype is currently under development.
